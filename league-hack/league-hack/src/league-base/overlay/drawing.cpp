...
//Drawing::Drawing()
//{
//    HWND hOverlayWindow = FindWindowA(NULL, "league-overlay");
//    if (!hOverlayWindow)
//        exit(1);
//
//    RECT rect;
...
//
//    HRESULT res = d3dObject->CreateDeviceEx(
//        D3DADAPTER_DEFAULT, 
//        D3DDEVTYPE_HAL, 
//        hOverlayWindow, 
...
//{
//    if (!fontf)
//        D3DXCreateFont(d3dDevice, 20, 0, FW_NORMAL, 1, false, DEFAULT_CHARSET, OUT_DEFAULT_PRECIS, ANTIALIASED_QUALITY, DEFAULT_PITCH | FF_DONTCARE, "Arial", &fontf);
//
//    RECT rect;
//
